 ...
 */
package com.jakwan.demo;

import com.jakwan.demo.exceptions.NonexistentEntityException;
import com.jakwan.demo.exceptions.PreexistingEntityException;
...
public class DatamahasiswaJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("com.jakwan_demo_jar_0.0.1-SNAPSHOTPU");
